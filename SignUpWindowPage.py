...
class SignUp:
    ...
    def add_header_section(self):
        ...
        self.welcome_label = Label(self.header_frame, text="Sign up to enter ",
    ...
    def register_user(self):
        ...
        if (name == "" or contact == "" or email == "" or pwd == ""):
            ...
            query = "Insert into Member(MemberName, MemberPassword,MemberContact, MemberEmailId) Values (%s,%s,%s,%s)"
